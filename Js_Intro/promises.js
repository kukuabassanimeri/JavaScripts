...
let countValue = new Promise(function (resolve, reject) {
  if (count) {
    resolve("There is a count value in the code!");
  } else {
    reject("There is no count value in the count!");
  }
});
//* Call the promise
...
let thisPromise = new Promise(function (resolve, reject) {
  let success = true;
  if (success) {
    resolve("You have passed the examination");
  } else {
    reject("You have failed the examination");
  }
});
...
//* Promise to check for the even number
let checkEven = new Promise(function (resolve, reject) {
  let num = 4;
  if (num % 2 === 0) {
...
//* SetTimeout function
function greetings() {
  console.log("Hello my wife cici");
}
//* setTimeout function
setTimeout(greetings, 2000);
console.log("This message shows up first before the setTimeout message.");
